...
class VOCDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        if 'train' in self.period:
            ...
            # 将 NumPy 数组存储在 sample 字典中的 'segmentation' 键下，以便稍后在数据集的 __getitem__ 方法中返回。
        ...
        # 七个字典，包括image、'name': '2008_006751'、 'row': 375、'col': 500、
        # segmentation、mask、segmentation_onehot
